...
upload_df_from_s3 = BashOperator(
    task_id="upload_df_from_s3",
    bash_command="python /home/ubuntu/utils_for_upload/upload_from_s3.py",
    dag=dag_spark,
...
spark_submit_local = SparkSubmitOperator(
    ...
    application ='/home/ubuntu/utils_for_upload/pyspark_handle_and_upload_csv.py' ,
    conn_id = 'spark_local', 
    dag=dag_spark
    )
